...
num_classes = 3
# Load the data files
file1 = np.loadtxt("LS_Group01/Class1.txt",delimiter= " ", skiprows=0)
file2 = np.loadtxt("LS_Group01/Class2.txt",delimiter= " ", skiprows=0)
file3 = np.loadtxt("LS_Group01/Class3.txt",delimiter= " ", skiprows=0)
...
for i in range(3):
    print(float(np.linalg.det(covar[i])))
