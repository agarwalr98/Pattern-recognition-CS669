...
# Load the data files
# file1 = np.loadtxt("group01.txt",delimiter= " ", skiprows=1)
# file2 = np.loadtxt("group01.txt",delimiter= " ", skiprows=1)

with open("group04.txt") as myfile:
    head = list(itertools.islice(myfile,1, 301))
# print(len(head))
np.asarray(head)
print(head[1])
...
# test data
Class1_test = np.zeros(shape=(int(Test_size_Class1),2), dtype=float)
...
Class2_test = np.zeros(shape=(int(Test_size_Class2),2), dtype=float)

with open("group04.txt") as myfile:
    head = list(itertools.islice(myfile,301, 801))
print(len(head))
# import training and testing data of class 2
j = 0 
for i in head:
    i = i.split()
...
print(len(head))
# import training and testing data of class 3
j = 0 
for i in head:
    i = i.split()
...
accuracy = float( float( Total_CorrectSamples)/ float(num_classes*(Test_size_Class1 + Test_size_Class2 + Test_size_Class3)))
